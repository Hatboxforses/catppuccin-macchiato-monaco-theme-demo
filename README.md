...
We start the program at the head setting the doc to read as html
```
<!DOCTYPE html>
<html>
  <head>
```
We set the icon of the page, set up UTF-8 to support emojis (& other unicode), & set the page title to Monaco Editor 
```
    <link rel="shortcut icon" type="image" jpeg" href="/images/monaco.jpg">
      <meta charset="UTF-8">
    <title>Monaco Editor</title>
  </head>
```
Start the body, set the size, load the editor javascript, & load the theme js
```
  <body>
    <div id="container" style="min-width: 98vw; min-height: 94vh"></div>
    <script src="./monaco-editor/min/vs/loader.js"></script>
    <script src="./monaco-editor/themes/macchiato.js"></script>
```
## macchiato.js
This sets a variable called "themeData" (this is important for later) followed by a modified version of the [vscode theme](https://github.com/catppuccin/vscode) there is also a [dracula version](https://github.com/Hatboxforses/catppuccin-macchiato-monaco-theme-demo/blob/main/monaco-editor/themes/dracula.js) (aptly named dracula.js) 
<details>
<summary>⚠️Warning long code block⚠️</summary>
<br>
...
Symlink folder, make a requirement for the editor.main file, & define a theme
```
		<script>
...
```
Set the variable editor to create a monaco editor window in the container div mentioned at the start of the document, add the value to say "Hello what a beautiful day it is to be a text editor! The website source code is available on Github! https://github.com/Hatboxforses/retard-central.neocities", set the language to text, set the theme end the script, then end the body closing the document
```
						var editor = monaco.editor.create(document.getElementById('container'), {
						  value: ['Hello what a beautiful day it is', 'to be a text editor!', 'The website source code is', 'available on Github!', 'https://github.com/Hatboxforses/retard-central.neocities'].join('\n'),
							language: 'text',
							theme: "my-dark"
					  });
      	});
